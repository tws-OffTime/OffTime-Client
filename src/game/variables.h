...
MACRO_CONFIG_STR(OTUsername, ot_username, 14, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "User username")
MACRO_CONFIG_STR(OTPassword, ot_password, 14, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "User password")
